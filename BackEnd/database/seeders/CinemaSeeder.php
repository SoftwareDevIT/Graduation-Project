    ...
    public function run()
    {
        ...
        DB::table('cinema')->insert([
            [
                ...
                'phone' => '0123456789',
                'location_id' => DB::table('location')->where('location_name', 'Hà Nội')->value('location_id'),
            ...
            [
                ...
                'phone' => '0123456789',
                'location_id' => DB::table('location')->where('location_name', 'TP Hồ Chí Minh')->value('location_id'),
            ...
            [
                ...
                'phone' => '0123456789',
                'location_id' => DB::table('location')->where('location_name', 'Đà Nẵng')->value('location_id'),
